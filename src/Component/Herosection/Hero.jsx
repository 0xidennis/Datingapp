  ...
  return (
    <div div className="min-h-screen  bg-white">
      ...
      mind that knowing how to make
       ...
       Say, you’re conversing with a female from one of the profiles. Your first motive would be getting 
        to 
      ...
      <ul className="list-disc list-inside text-gray-700 text-justify">
        ...
        <li>Communicating with external individuals, people outside the organization.
            This helps us to keep a stable relationship and learn from clients’ overall experience.</li>
        <li>Reflective communication: we stay in contact with our agents to monitor all happenings.
            This includes communicating through phone calls. Our supervisors also create a
            strong presence by keeping in touch with assigned escorts.</li>
        <li>Developing and retaining useful knowledge: the secret behind our commitment
      ...
      <ul className="list-disc list-inside text-gray-700 text-justify">
        ...
        <li>Oral comprehension: this is one skill every escort must have — the ability to collect and 
          ...
          ideas in spoken words.
            This helps us to keep a stable relationship and learn from clients’ overall experience.</li>
        <li>Problem sensitivity: this serves as the ability to identify issues or situations going 
          sideways. 
          Note that it’s not the escorts’ job to solve the problems. They only have to identify them</li>
        <li>Fluency: English serves as the easiest and common way of communicating. All our escorts are 
          great speakers.
        </li>
        <li>Customer experience: have in mind that you’ll be dealing with experienced companions, 
          whose job is to make time worth spending together.
        </li>
      </ul>
